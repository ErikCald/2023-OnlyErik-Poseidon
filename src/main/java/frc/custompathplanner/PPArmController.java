 ...
 * calculate() method
 * takes in a PathPlannerState directly - Continuous input is automatically
 * enabled for the rotation
 * controller - Holonomic angular velocity is used as a feedforward for the
 * rotation controller,
 * which no longer needs to be a @ProfiledPIDController
 */
public class PPArmController {
